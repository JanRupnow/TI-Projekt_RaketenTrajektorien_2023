...
def update_key_in_json_rocket(json, identifier: int, value: str):
    for category in json.keys():
        try:
            for key in json[category].keys():
...
# Rocket Controls
def get_h_rocket_boost_forward(hotkeys_json) -> (int, str):
    return [
...
def get_h_rocket_boost_left(hotkeys_json) -> (int, str):
    return [
...
def get_h_rocket_boost_right(hotkeys_json) -> (int, str):
    return [
...
def get_h_lower_rocket_boost(hotkeys_json) -> (int, str):
    return [
...
# Rocket Zooms
def get_h_zoom_rocket_start(hotkeys_json) -> (int, str):
    return [
...
def get_h_zoom_rocket_planet(hotkeys_json) -> (int, str):
    return [
...
def get_h_zoom_rocket_planet_system(hotkeys_json) -> (int, str):
    return [
...
def get_h_zoom_auto_on_rocket(hotkeys_json) -> (int, str):
    return [
...
def get_h_zoom_auto_on_reference_planet(hotkeys_json) -> (int, str):
    return [
...
# Centering
def get_h_center_on_sun(hotkeys_json) -> (int, str):
    return [
...
def get_h_center_on_rocket(hotkeys_json) -> (int, str):
    return [
...
# Time Manipulation
def get_h_shift_time_step_up(hotkeys_json) -> (int, str):
    return [
...
def get_h_shift_time_step_down(hotkeys_json) -> (int, str):
    return [
...
# Generals
def get_h_draw_line(hotkeys_json) -> (int, str):
    return [
...
def get_h_show_distance(hotkeys_json) -> (int, str):
    return [
...
def get_h_pause_simulation(hotkeys_json) -> (int, str):
    return [
...
def get_h_switch_interface(hotkeys_json) -> (int, str):
    return [
...
# Navigation
def get_h_leave_simulation(hotkeys_json) -> (int, str):
    return [
...
def get_h_open_settings(hotkeys_json) -> (int, str):
    return [
...
def get_h_close_window(hotkeys_json) -> (int, str):
    return [
...
def get_h_move_screen_up(hotkeys_json) -> (int, str):
    return [
...
def get_h_move_screen_down(hotkeys_json) -> (int, str):
    return [
...
def get_h_move_screen_right(hotkeys_json) -> (int, str):
    return [
...
def get_h_move_screen_left(hotkeys_json) -> (int, str):
    return [
